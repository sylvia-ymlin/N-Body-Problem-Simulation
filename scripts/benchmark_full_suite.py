...
def run_diagnostic_suite(binary):
    # All versions compared at N=100k, serial
    input_100k = "data/inputs/bench_strong_100000.gal"
    ensure_input(input_100k, 100000, "disk")

    cases = [
        {"version": 1, "N": 100000, "file": input_100k, "threads": 1, "theta": 0.5, "k": 0},
        {"version": 2, "N": 100000, "file": input_100k, "threads": 1, "theta": 0.5, "k": 0},
        {"version": 3, "N": 100000, "file": input_100k, "threads": 1, "theta": 0.5, "k": 0},
        {"version": 4, "N": 100000, "file": input_100k, "threads": 1, "theta": 0.5, "k": 0},
    ]
...
def run_full_suite(
    ...
    output_path="data/metrics/full_results.json",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="data/metrics/full_results.json")
    parser.add_argument("--threads", default="1,2,4,8,16,20,32")
