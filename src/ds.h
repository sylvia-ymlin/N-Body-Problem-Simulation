 ...
 * TNode: QuadTree Node
 *
 * Minimalist structure representing a spatial region or a single particle.
 */
...
/**
 * NodeArena: Bump Allocator for Tree Nodes
 *
 * Drastically improves performance by ensuring spatial siblings are memory
 * siblings.
 */
typedef struct {
  TNode *buffer;
